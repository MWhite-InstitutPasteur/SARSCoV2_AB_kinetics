...
tiff(file="Fig1_AB_data.tif", width=40, height=22, units="cm", res=500)
...
points( x = AB_data$days_pso, y = AB_data$spike_IgG,
...
Spike_IgG_N_neg <- AB_data$spike_IgG[ which( AB_data$status == "neg" ) ]
...
points( x = AB_data$days_pso, y = AB_data$RBD_IgG,
	  pch=19, cex=pos.point.size, 
        col=AB_data$colour )
...
RBD_IgG_N_neg <- AB_data$RBD_IgG[ which( AB_data$status == "neg" ) ]
...
points( x = AB_data$days_pso, y = AB_data$NP_IgG,
	  pch=19, cex=pos.point.size, 
        col=AB_data$colour )
...
NP_IgG_N_neg <- AB_data$NP_IgG[ which( AB_data$status == "neg" ) ]
...
points( x = AB_data$days_pso, y = AB_data$spike_IgM,
	  pch=19, cex=pos.point.size, 
        col=AB_data$colour )
...
Spike_IgM_N_neg <- AB_data$spike_IgM[ which( AB_data$status == "neg" ) ]
...
points( x = AB_data$days_pso, y = AB_data$RBD_IgM,
	  pch=19, cex=pos.point.size, 
        col=AB_data$colour )
...
RBD_IgM_N_neg <- AB_data$RBD_IgM[ which( AB_data$status == "neg" ) ]
...
points( x = AB_data$days_pso, y = AB_data$NP_IgM,
	  pch=19, cex=pos.point.size, 
        col=AB_data$colour )
...
NP_IgM_N_neg <- AB_data$NP_IgM[ which( AB_data$status == "neg" ) ]
...
points( x = AB_data$days_pso, y = AB_data$spike_IgA,
	  pch=19, cex=pos.point.size, 
        col=AB_data$colour )
...
Spike_IgA_N_neg <- AB_data$spike_IgA[ which( AB_data$status == "neg" ) ]
...
points( x = AB_data$days_pso, y = AB_data$RBD_IgA,
	  pch=19, cex=pos.point.size, 
        col=AB_data$colour )
...
RBD_IgA_N_neg <- AB_data$RBD_IgA[ which( AB_data$status == "neg" ) ]
...
points( x = AB_data$days_pso, y = AB_data$NP_IgA,
	  pch=19, cex=pos.point.size, 
        col=AB_data$colour )
...
NP_IgA_N_neg <- AB_data$NP_IgA[ which( AB_data$status == "neg" ) ]
