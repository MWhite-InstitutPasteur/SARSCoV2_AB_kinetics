...
tiff(file="SupFig3_Ab_data_HKU1_NL63_229E.tif", width=40, height=22, units="cm", res=500)
...
points( x = AB_data$days_pso, y = AB_data$HKU1_IgG,
...
Spike_IgG_N_neg <- AB_data$HKU1_IgG[ which( AB_data$status == "neg" ) ]
...
points( x = AB_data$days_pso, y = AB_data$NL63_IgG,
	  pch=19, cex=pos.point.size, 
        col=AB_data$colour )
...
RBD_IgG_N_neg <- AB_data$NL63_IgG[ which( AB_data$status == "neg" ) ]
...
points( x = AB_data$days_pso, y = AB_data$X229E_IgG,
	  pch=19, cex=pos.point.size, 
        col=AB_data$colour )
...
NP_IgG_N_neg <- AB_data$X229E_IgG[ which( AB_data$status == "neg" ) ]
...
points( x = AB_data$days_pso, y = AB_data$HKU1_IgM,
	  pch=19, cex=pos.point.size, 
        col=AB_data$colour )
...
Spike_IgM_N_neg <- AB_data$HKU1_IgM[ which( AB_data$status == "neg" ) ]
...
points( x = AB_data$days_pso, y = AB_data$NL63_IgM,
	  pch=19, cex=pos.point.size, 
        col=AB_data$colour )
...
RBD_IgM_N_neg <- AB_data$NL63_IgM[ which( AB_data$status == "neg" ) ]
...
points( x = AB_data$days_pso, y = AB_data$X229E_IgM,
	  pch=19, cex=pos.point.size, 
        col=AB_data$colour )
...
NP_IgM_N_neg <- AB_data$X229E_IgM[ which( AB_data$status == "neg" ) ]
...
points( x = AB_data$days_pso, y = AB_data$HKU1_IgA,
	  pch=19, cex=pos.point.size, 
        col=AB_data$colour )
...
Spike_IgA_N_neg <- AB_data$HKU1_IgA[ which( AB_data$status == "neg" ) ]
...
points( x = AB_data$days_pso, y = AB_data$NL63_IgA,
	  pch=19, cex=pos.point.size, 
        col=AB_data$colour )
...
RBD_IgA_N_neg <- AB_data$NL63_IgA[ which( AB_data$status == "neg" ) ]
...
points( x = AB_data$days_pso, y = AB_data$X229E_IgA,
	  pch=19, cex=pos.point.size, 
        col=AB_data$colour )
...
NP_IgA_N_neg <- AB_data$X229E_IgA[ which( AB_data$status == "neg" ) ]
